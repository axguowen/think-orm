...
abstract class PDOConnection extends Connection
{
     ...
     * @return string
     */
    protected function getSchemaCacheKey($schema)
    {
     ...
     * @return array
     */
    public function getSchemaInfo($tableName, $force = false)
    {
        if (!strpos($tableName, '.')) {
        ...
        if (!isset($this->info[$schema]) || $force) {
            ...
            $pk      = isset($info['_pk']) ? $info['_pk'] : null;
            $autoinc = isset($info['_autoinc']) ? $info['_autoinc'] : null;
     ...
     * @return string
     */
    public function getUniqueXid($suffix = '')
    {
