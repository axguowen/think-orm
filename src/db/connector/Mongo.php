...
class Mongo extends Connection
{
     ...
     * @throws RuntimeException
     */
    public function getCursor(BaseQuery $query, $mongoQuery, $master = false)
    {
     ...
     * @throws RuntimeException
     */
    protected function mongoQuery(BaseQuery $query, $mongoQuery)
    {
        $options = $query->parseOptions();
     ...
     * @throws RuntimeException
     */
    public function command(Command $command, $dbName = '', ReadPreference $readPreference = null, $typeMap = null, $master = false)
    {
        $this->initConnect($master);
        $this->db->updateQueryTimes();
    ...
    public function find(BaseQuery $query)
    {
        ...
        return isset($resultSet[0]) ? $resultSet[0] : [];
    }
